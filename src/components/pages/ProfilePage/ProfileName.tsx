        ...
        edit
          ...
          <div className='flex justify-center items-center space-x-4'>
            <input className='rounded-md border-0 p-1 py-1.5 text-gray-900 shadow-m ring-1 ring-inset ring-gray-300 placeholder:text-gray-400
                                  focus:ring-2 focus:ring-inset focus:ring-violet-600 text-sm  sm:text-xl sm:leading-6 '
                   placeholder='Your new name' value={newName} onChange={(e) => setNewName(e.target.value)}
            />
